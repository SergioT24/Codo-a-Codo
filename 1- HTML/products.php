...
<body>
    <header> 
      ...
      <div class="text-center">
        <a href="../1- html/products.php"><img src="../1- html/img/Bombacha.svg" class="rounded" alt="..."></a>
        <img src="../1- html/img/Bóxer.svg" class="rounded" alt="...">
        <img src="../1- html/img/Conjuntos.svg" class="rounded" alt="...">
        <img src="../1- html/img/Infantil.svg" class="rounded" alt="...">
        <img src="../1- html/img/Medias.svg" class="rounded" alt="...">
        <img src="../1- html/img/Pijamas.svg" class="rounded" alt="...">
        <img src="../1- html/img/Remeras.svg" class="rounded" alt="...">
        <img src="../1- html/img/Taza.svg" class="rounded" alt="...">
      </div>
