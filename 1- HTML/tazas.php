...
<body>
  ...
  <div class="item" data-producto-id="1">
    <img src="../1- html/img/taza1.jpg" class="img-fluid" alt="...">
    <div class="precio">
      <span class="nombre">Taza sublimada 1</span>
      <span class="precio">$1.200</span>
      <a class="boton-comprar btn btn-primary">Comprar</a>
    </div>
  </div>
    <div class="item">
      <img src="../1- html/img/taza2.jpg" class="img-fluid" alt="...">
      <div class="precio">
        <span class="nombre">Taza sublimada 2</span>
        <span class="precio">$1.300</span>
        <a class="boton-comprar btn btn-primary">Comprar</a>
      </div>
    </div>
    <div class="item">
      <img src="../1- html/img/taza3.jpg" class="img-fluid" alt="...">
      <div class="precio">
        <span class="nombre">Taza sublimada 3</span>
