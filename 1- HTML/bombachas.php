...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">
          <img src="../1- html/img/logo_transparente.png" alt="" class="logo">
        </a>
  ...
  <div class="div-img">
    <div class="item" data-producto-id="1">
      <img src="../1- html/img/Bombachas1.jpeg" class="img-fluid" alt="...">
      <div class="precio">
        <span class="nombre">Bombacha 1</span>
        <span class="precio">$1.200</span>
        <a class="boton-comprar btn btn-primary">Comprar</a>
      </div>
    </div>
    <div class="item" data-producto-id="2">
      <img src="../1- html/img/Bombachas2.jpeg" class="img-fluid" alt="...">
      <div class="precio">
        <span class="nombre">Bombacha 2</span>
        <span class="precio">$1.300</span>
        <a class="boton-comprar btn btn-primary">Comprar</a>
      </div>
    </div>
    <div class="item" data-producto-id="3">
      <img src="../1- html/img/Bombachas3.jpeg" class="img-fluid" alt="...">
      <span class="precio"><span class="nombre">Bombacha 3</span>
  ...
  <footer>
    ...
    <a href="https://web.whatsapp.com/send?phone=+541150157955" target="_blank">
      <img src="../1- html/img/wp.svg" alt="Logo de WhatsApp" width="20">
    </a>
  </footer>
