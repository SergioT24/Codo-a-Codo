...
<body>
    ...
    <div class="div-img">
      <div class="item" data-producto-id="1">
        <img src="../1- html/img/remeras1.jpeg" class="img-fluid" alt="...">
        <div class="precio">
          <span class="nombre">Remera 1</span>
        ...
        <div class="item" data-producto-id="2">
          ...
          <div class="precio">
            <span class="nombre">Remera  2</span>
            <span class="precio">$1.300</span>
            <a class="boton-comprar btn btn-primary">Comprar</a>
          </div>
        </div>
        <div class="item" data-producto-id="3">
          <img src="../1- html/img/pijama3.jpeg" class="img-fluid" alt="...">
          <div class="precio">
            <span class="nombre">Pijama 3</span>
