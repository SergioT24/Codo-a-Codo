    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                ...
                <form class="d-flex">
                    <a class="nav-link active" aria-current="page" id="buy" id="compras" href="../1- html/buy.php"> <img src="../1- html/img/bolsa_compras.png" alt="Logo carrito de compras" width="25"></a>
