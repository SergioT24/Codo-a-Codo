...
<body>
  ...
  <div id="productosComprados" class="div-img"></div>
  
  <table class="table">
    <thead class="table-dark">
      <tr>
        <span><th scope="col">#</th></span>
        <span><th scope="col">Producto</th></span>
        <span><th scope="col">Precio</th></span>
        <span><th scope="col">Cantidad</th></span>
        <span><th scope="col">Subtotal</th></span>
      </tr>
    </thead>
    <tbody>
      <tr>
        <span><th scope="row">1</th></span>
        <span><td>Bombacha 1</td></span>
        <span><td>$1.400</td></span>
        <span><td>2</td></span>
        <span><td>$2.800</td></span>
      </tr>
      <tr>
        <span><th scope="row">2</th></span>
        <span><td>Bombacha 2</td></span>
        <span><td>$1.500</td></span>
        <span><td>2</td></span>
        <span><td>$3.000</td></span>
      </tr>
      <tr>
        <span><th scope="row">3</th></span>
        <span><td>Bombacha 3</td></span>
        <span><td>$1.600</td></span>
        <span><td>2</td></span>
        <span><td>$3.200</td></span>
      </tr>
    </tbody>
