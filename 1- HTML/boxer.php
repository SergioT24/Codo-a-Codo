...
<body>
  ...
  <div class="div-img">
    <div class="item">
      <img src="../1- html/img/boxer1.jpeg" class="img-fluid" alt="...">
      <div class="precio">
        <span class="nombre">Bóxer 1</span>
        <span class="precio">$1.200</span>
        <a class="boton-comprar btn btn-primary">Comprar</a>
      </div>
    </div>
    <div class="item"><img src="../1- html/img/boxer2.jpeg" class="img-fluid" alt="...">
      <div class="precio">
        <span class="nombre">Bóxer 2</span>
        <span class="precio">$1.200</span>
        <a class="boton-comprar btn btn-primary">Comprar</a>
      </div>
    </div>
    <div class="item"><img src="../1- html/img/boxer3.jpeg" class="img-fluid" alt="...">
      <div class="precio">
        <span class="nombre">Bóxer 3</span>
        <span class="precio">$1.200</span>
        <a class="boton-comprar btn btn-primary">Comprar</a>
      </div>
    </div>
