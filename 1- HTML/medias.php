...
<body>
  ...
  <div class="div-img">
    <div class="item" data-producto-id="1">
      <img src="../1- html/img/medias1.jpeg" class="img-fluid" alt="...">
      <div class="precio">
        <span class="nombre">Medias 1</span>
        <span class="precio">$1.200</span>
        <a class="boton-comprar btn btn-primary">Comprar</a>
      </div>
    </div>
    <div class="item" data-producto-id="2">
      <img src="../1- html/img/medias2.jpeg" class="img-fluid" alt="...">
      <div class="precio">
        <span class="nombre">Medias 2</span>
